  ...
  background-color: #f1f1f1;
    ...
    <body>
        ...
        <?php
           ...
           echo "<tr><th>Leave_Apply_ID</th><th>User_Name</th><th>User_id</th><th>Leave_Name</th><th>From_Date</th><th>To_Date</th><th>Total_Days</th><th>Reason</th><th>Status</th><th>Applied_Date</th> <th colspan='2''>Approve/Reject</th></tr>";
           while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
           echo "<tr><td><div class='orderID'>" . $row['leave_apply_id'] . "</div></td><td>" . $row['user_name'] . "</td><td>"  . $row['user_id'] . "</td><td>" .  $row['leave_type'] . "</td><td>" . $row['from_date'] . "</td><td>" . $row['to_date'] . "</td><td>" . $row['total_days'] . "</td><td>" . $row['reason'] . "</td><td>" . $row['status'] . "</td><td>" . $row['applied_date'] . "</td><td align=center><input  type='submit' value='Accept' id='b1' onclick='Accept(this);' /></td><td align=center ><input  type='submit' value='Reject' id='b2' onclick='Reject(this);' /></td></tr>";  //$row['index'] the index here is a field name
           }
